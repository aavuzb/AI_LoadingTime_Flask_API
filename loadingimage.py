...
class Load():
    def __init__(self):
        ...
        self.label_lines = [line.rstrip() for line 
                           in tf.gfile.GFile(os.path.join(self.dir_path, "models/retrained_labels.txt"))]
        self.create_graph()
        self.sess = tf.Session()

    def create_graph(self):
        with tf.gfile.FastGFile(os.path.join(self.dir_path, "models/retrained_graph.pb"), 'rb') as f:
